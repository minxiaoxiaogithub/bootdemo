...
public class GlobalExceptionHandler {
   ...
   * Exception处理方法
   * 
   * (ExceptionHandler经过测试，好像只匹配具体类型， 如MyException，父类为Exception,只会触发如MyException处理类！)
   *
   * @param req
   * @param e
   * @return
  ...
  @ResponseBody
  public ErrorInfo<String> jsonErrorHandler2(HttpServletRequest req, Exception e) {
    System.out.println("++++++++++++++++++");
    ErrorInfo<String> errorInfo = new ErrorInfo<String>();
    errorInfo.setMessage(e.getMessage());
    errorInfo.setCode(ErrorInfo.ERROR);
